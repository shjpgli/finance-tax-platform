...
--
-- insert into sys_menu(menuId, menuName, menuUrl, parentId, perms, type, icon, sort, status, remark) values('8cc2385f-f82d-4301-b20f-fca1aac3bca8','test01','test01','1' ,'test01','1','test01',1 ,true, 'test01');
