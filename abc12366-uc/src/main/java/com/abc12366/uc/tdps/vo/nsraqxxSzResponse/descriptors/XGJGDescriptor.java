...
/**
 * Class XGJGDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class XGJGDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public XGJGDescriptor() {
        ...
        //-- _GSCG
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_GSCG", "GSCG", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
