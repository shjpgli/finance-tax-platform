...
public class WxConnectFactory {
    ...
    public static void main(String[] args) {
        ...
        //String
		// token="h9jqMNQCcdpccfb_mudt1ZyRqgFjUxZuOyfpO8z2XVWERyd4Hdt8wLsIZYAQ2vZaDG3Sw6TZHPJzwOJ0S5dYCRnNfmhoCDb6RvtM6GL7Buw3SeXfLy0aiMVqTwGys2OKNIBjAFARMF";
        //WxUseToken useToken=  get("https://api.weixin.qq
		// .com/cgi-bin/token?grant_type=client_credential&appid=wxcc69b5b49f2f232e&secret
		// =b2fe7d55be613ffee9242869d538daa6",null,WxUseToken.class);
        //System.out.println(useToken.getAccess_token());
    	/* Map<String,String> tks=new HashMap<String, String>();
       ...
       /*  Map<String,String> tks1=new HashMap<String, String>();
    	 tks1.put("access_token", token);
    	 //BaseWxRespon respon=get("https://api.weixin.qq.com/cgi-bin/template/get_all_private_template",tks1,null,
    	 BaseWxRespon.class);
     	 TemplateMsg msg=new TemplateMsg();
     	 msg.setTemplate_id("CiHtyuUVWkL76AVEaUjYqcJevaQJMqzl7OKhVVruVwU");
    	 BaseWxRespon respon=post("https://api.weixin.qq.com/cgi-bin/template/del_private_template",tks1,msg,
    	 BaseWxRespon.class);*/
