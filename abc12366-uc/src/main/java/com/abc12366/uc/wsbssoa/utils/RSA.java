...
public class RSA {
    ...
    /**保存生成的密钥对的文件名称。 */
    private static final String RSA_PAIR_FILENAME = "/RSAKey.txt";
    /** 密钥大小 */
    ...
    static {
        ...
        LOGGER.info("liunx路径:"+rsaPairFile.getPath());
    }
...
//        LOGGER.info("linux路径:"+urlPath);
//        LOGGER.info("linux路径:"+urlPath1);
//
//        return (new File(urlPath).getParent() + RSA_PAIR_FILENAME);
    }
