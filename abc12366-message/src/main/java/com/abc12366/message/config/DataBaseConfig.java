...
public class DataBaseConfig implements EnvironmentAware {
    ...
    public SqlSessionFactory db1SqlSessionFactory() throws SQLException {
        ...
        // 自动重命名
        sqlSessionFactoryBean.setTypeAliasesPackage("com.abc12366.message.model");
        // 设置 typeHandler
...
//        sqlSessionFactory.setPlugins(new Interceptor[]{pageHelper});
        ...
        try {
            ...
            sqlSessionFactoryBean.setMapperLocations(resolver
                    .getResources("classpath:com/abc12366/message/mapper/db1/*.xml"));
...
//        sqlSessionFactory.setPlugins(new Interceptor[]{pageHelper});
        ...
        try {
            ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
            sqlSessionFactoryBean.setMapperLocations(resolver
                    .getResources("classpath:com/abc12366/message/mapper/db2/*.xml"));
            return sqlSessionFactoryBean.getObject();
        } catch (Exception e) {
